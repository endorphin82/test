...
function ArticlesTable({ articles, loaded, loading, classes, loadAllArticles, deleteArticleById }) {
  useEffect(() => {
                      ...
                      <TableCell align="right">
                        <div className={classes.flexible}>
                          ...
                          <Tooltip title="Delete">
                            <IconButton onClick={() => deleteArticleById(article.postId)} color="secondary"
                                        aria-label="Delete">
